...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        loadChangelog: function loadChangelog() {
            var minorVersion = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";

            var self = this;

            Nova.request().get("/genealabs/laravel-changelog/api/entries/" + minorVersion).then(function (response) {
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("h1", { staticClass: "mb-6" }, [_vm._v("Change Log")]),
      _vm._v(" "),
      _c(
        "loading-view",
        { attrs: { loading: _vm.isLoading } },
        _vm._l(_vm.changelog, function(entry, index) {
              ...
              ? _c(
                  ...
                  [
                    _c("h2", { staticClass: "mb-2" }, [
                      _c("span", {
                        domProps: { textContent: _vm._s(entry.version) }
                      }),
                      _vm._v(" "),
                      _c("span", {
                        staticClass: "text-70 font-normal ml-6",
                        domProps: { textContent: _vm._s(entry.date) }
                      })
                    ]),
                    _vm._v(" "),
                    _c("card", { staticClass: "mb-8 p-4" }, [
                      _c("p", {
                        staticClass: "details",
                        domProps: { innerHTML: _vm._s(entry.details) }
                      })
                    ])
                  ],
                  1
